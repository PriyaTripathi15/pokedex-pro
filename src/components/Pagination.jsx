  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-8 flex-wrap">
      <button
        ...
        className="rounded-lg border border-yellow-400/20 bg-red-500 px-4 py-2 text-white transition-colors hover:bg-red-600 disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-white/35"
      >
        ← Previous
      </button>
